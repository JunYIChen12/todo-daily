...
Write-Host "Daily Todo installed to: $InstallDir"
Write-Host "Startup task registered: Daily Todo Background Reminders"

if (-not $NoStart) {
  Start-TodoDaily -TargetDir $InstallDir
  Write-Host "Background service started and page opened."
}
